...
public class DiscussionManagerTest {
    ...
    public void test_add_invalid_items(){
        ...
        Discussion d6 =  new Discussion(tmpTopic,title,content,tmpUser,"no date"); // discussion with no date

        // trying to add them
        d_manager.add(d1);d_manager.add(d2);d_manager.add(d3);d_manager.add(d4);d_manager.add(d5);d_manager.add(d6);
